...
void Economy::upgradeLoom(sf::IntRect newTexture)
{
	hud.getBuilding_Loom().setTextureRect(newTexture);
}

void Economy::upgradeMarket(sf::IntRect newTexture)
{
	hud.getBuilding_Market().setTextureRect(newTexture);
}

void Economy::upgradeGarden(sf::IntRect newTexture)
{
